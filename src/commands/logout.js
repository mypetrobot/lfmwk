...
class LogoutCommand extends Command {
    ...
    async run(client, message, args) {
        ...
        'This will also delete all of your crowns.\n\n**If you just need to change your last.fm username, please message a member of the mod team.**\n\nOtherwise click on this reaction to proceed with the logout. ')
        await msg.react('✅')
